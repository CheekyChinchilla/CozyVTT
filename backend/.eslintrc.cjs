  ...
  overrides: [
    {
      ...
      'src/scripts/migrate-characters.ts',
      'src/scripts/validate-characters.ts',
      'src/services/campaignExporter.ts',
      'src/services/campaignImporter.ts',
      'src/services/sessionState.ts',
      'src/utils/asset-urls.ts',
      'src/utils/character-templates/__tests__/templates.test.ts',
      'src/utils/character-templates/callOfCthulhu7e-templates.ts',
      'src/utils/character-templates/dnd5e-templates.ts',
      ...
      'src/websocket/handlers/atmosphere.ts',
      'src/websocket/handlers/characters.ts',
      'src/websocket/handlers/dice.ts',
      'src/websocket/handlers/fog.ts',
      'src/websocket/handlers/initiative.ts',
      'src/websocket/handlers/lights.ts',
      'src/websocket/handlers/maps.ts',
      'src/websocket/handlers/spirit.ts',
      'src/websocket/handlers/tokens.ts',
      'src/websocket/handlers/walls.ts',
      'src/websocket/index.ts',
      'src/websocket/shared.ts',
